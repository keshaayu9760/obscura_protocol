...
# Deploys veil_strike_v1.aleo to Aleo testnet
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CONTRACT_DIR="$SCRIPT_DIR/../contract/veil_strike_v1"
...
echo "Program:  veil_strike_v1.aleo"
echo ""
...
echo "============================================"
echo ""
echo "Program ID: veil_strike_v1.aleo"
echo "Network:    $NETWORK"
echo ""
echo "Next steps:"
