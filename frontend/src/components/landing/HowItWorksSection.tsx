...
const steps = [
  ...
  { step: '02', title: 'Choose a Market', description: 'Browse event prediction markets or 15-minute Eclipse Rounds. Real-time odds powered by FPMM AMM — auto-resolved by the Round Bot.' },
