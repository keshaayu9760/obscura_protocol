...
export const config = {
  ...
  programId: 'obscura_v2.0.aleo',
  programIdCx: 'obscura_v2.0_cx.aleo',
  programIdSd: 'obscura_v2.0_sd.aleo',
  allProgramIds: ['obscura_v2.0.aleo', 'obscura_v2.0_cx.aleo', 'obscura_v2.0_sd.aleo'] as const,
