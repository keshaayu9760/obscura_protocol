...
export const config = {
  ...
  programId: 'obscura_v2_0.aleo',
  programIdCx: 'obscura_v2_0_cx.aleo',
  programIdSd: 'obscura_v2_0_sd.aleo',
  allProgramIds: ['obscura_v2_0.aleo', 'obscura_v2_0_cx.aleo', 'obscura_v2_0_sd.aleo'] as const,
